...
[ChatGPT是怎样被训练出来的？ - 知乎](https://www.zhihu.com/zvideo/1584941670507896832)
...
例如，对于「它编造[大脸猫](https://www.modevol.com/note/clg30qjiu00qm01s97aj2auig?episodeId=clf9d5kni0zo301mm6tkl9t87#%E5%A4%A7%E8%84%B8%E7%8C%AB%E5%A8%81%E6%85%91)」的毛病，无法通过直接修改它的回答来矫正，只能通过再训练它做「“三体人为什么害怕大脸猫的威慑？三体人和大脸猫无关”」的单字接龙来调整模型。可这样调整后的效果如何、是否会矫枉过正，或是引入其他问题，又得通过多次提问来评估，容易顾此失彼，效率低下。
...
之前的[古诗提问](https://www.modevol.com/note/clg30qjiu00qm01s97aj2auig?episodeId=clf9d5kni0zo301mm6tkl9t87#%E6%9C%AA%E8%A7%81%E7%9A%84%E6%8F%90%E9%97%AE)，倘若真的仅有三个例子（学习材料），那 ChatGPT 其实也学不到什么通用规律，无法对它没见过的提问做出合理回答，更别提去应对用户的无数奇怪问法了。
...
但是，要实现这个目标并不容易，首先就需要一个更合适的理论框架来描述现象。因为我们在第三章已经看到了，大语言模型也会[创新](https://www.modevol.com/note/clg30qjiu00qm01s97aj2auig?episodeId=clf9d5kni0zo301mm6tkl9t87#%E5%88%9B%E6%84%8F%E5%BC%95%E5%AF%BC)，因此单纯喊出“要培养创新型人才”没有实际指导意义，必须要对「知识的层级」做更精细的划分，将「更高层次的创新」和「大语言模型的创新」加以区分，明确指出「什么样的创新人才」才值得培养，提供相应的培养工具和易于实施的普及方案，并在各方角色的共同配合下才有可能成功，因此一直推进缓慢。
...
去年大家    应用的都是 写小说、写剧本，没什么价值。

- 都在通用  增量训练，微调使大模型能力增强
- 在通过prombt，让他统一NLP的任务
- 发现了提示的妙用

1） 看看去年的ppt

2） 语言理解，参数量， 0样本以及 对话能力 coding能力， 分步骤替换能力。实验

到了此种规模的 GPT-3 就轻松学会了各种词语搭配和语法规则，能明白同一个意思的不同表达，还学会了编程语言，以及不同语言之间的关系，可以给出高质量的外语翻译，还能把我们的口语转换成代码。

关键探索验证，发现了新大陆：

→ 发现生成，预测下一个token的妙用，根据上文我就知道下文

→ 理解了要干什么？  神经网络已经出现了功能区？
...
再一次逼近了人的大脑，实现方式不同，同时在某些单项能力上远超人类。  记忆、交流、应用

1、记忆知识，教他模版，给他反馈，  让他

2、把它当成基石， 因为解锁了 语言处理智能单元，知识学习能力，  作为连接器。

**所以尽快掌握大语言模型的原理和基本应用， 然后到gpt的应用场景里面去，比如EVA**

\-- 从错误中学习， 研究大模型的人，为啥判断错了方向？

关键现象的发现：  在prompt，零样本中，人在环路中发现的。

记住有效信息的压缩，  “语言理解”->模版学习（）

错误：

所谓结构化知识的学习，但是大语言模型+少量模板，居然就能够学会   “任务”，规律

彻底弄清楚，到底变了啥，和之前。

1） → 真的能够理解了语言，   --- 知道了任务。     压缩
